...
class Symbolicator:
    def __init__(self, project, release, event_id):
        ...
        self.sess = SymbolicatorSession(
            ...
            source=get_internal_source(project, release),
        )
    ...
    def process_payload(self, stacktraces, dist):
        return self._process(
            lambda: self.sess.symbolicate_stacktraces(stacktraces=stacktraces, dist=dist),
...
def get_internal_source(project, release):
    """
...
class SymbolicatorSession:
    ...
    def __init__(self, url=None, source=None, project_id=None, event_id=None, timeout=None):
        self.url = url
    ...
    def symbolicate_stacktraces(self, stacktraces, dist):
        json = {
            "source": self.source,
        ...
        return self._create_task("sourcemap", json=json)
